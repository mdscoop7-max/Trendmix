...
/* Cart + checkout labels kept in the same shared language layer, including German. */
const commerceTranslations={
 nl:{perPiece:'per stuk',subtotal:'Subtotaal',decrease:'Aantal verminderen',increase:'Aantal verhogen',remove:'Product verwijderen',clearCart:'Winkelwagen leegmaken',total:'Totaal',checkout:'Afrekenen →',cartTitle:'Je winkelwagen',continueShopping:'← Verder winkelen',checkoutTitle:'Afrekenen',checkoutIntro:'Je bestelling is klaar. De betaal- en leverancierkoppeling moet nog worden aangesloten voordat een echte betaling kan worden verwerkt.',adjustCart:'Winkelwagen aanpassen'},
 en:{perPiece:'per item',subtotal:'Subtotal',decrease:'Decrease quantity',increase:'Increase quantity',remove:'Remove product',clearCart:'Clear cart',total:'Total',checkout:'Checkout →',cartTitle:'Your cart',continueShopping:'← Continue shopping',checkoutTitle:'Checkout',checkoutIntro:'Your order is ready. Payment and supplier integration still need to be connected before a real payment can be processed.',adjustCart:'Adjust cart'},
 fr:{perPiece:'par article',subtotal:'Sous-total',decrease:'Diminuer la quantité',increase:'Augmenter la quantité',remove:'Supprimer le produit',clearCart:'Vider le panier',total:'Total',checkout:'Passer au paiement →',cartTitle:'Votre panier',continueShopping:'← Continuer vos achats',checkoutTitle:'Paiement',checkoutIntro:'Votre commande est prête. Le paiement et la connexion fournisseur doivent encore être activés avant de pouvoir traiter un paiement réel.',adjustCart:'Modifier le panier'},
 de:{perPiece:'pro Stück',subtotal:'Zwischensumme',decrease:'Menge verringern',increase:'Menge erhöhen',remove:'Produkt entfernen',clearCart:'Warenkorb leeren',total:'Gesamt',checkout:'Zur Kasse →',cartTitle:'Dein Warenkorb',continueShopping:'← Weiter einkaufen',checkoutTitle:'Kasse',checkoutIntro:'Deine Bestellung ist bereit. Zahlungs- und Lieferantenanbindung müssen noch aktiviert werden, bevor eine echte Zahlung verarbeitet werden kann.',adjustCart:'Warenkorb anpassen'},
 it:{perPiece:'per pezzo',subtotal:'Subtotale',decrease:'Diminuisci quantità',increase:'Aumenta quantità',remove:'Rimuovi prodotto',clearCart:'Svuota carrello',total:'Totale',checkout:'Vai al pagamento →',cartTitle:'Il tuo carrello',continueShopping:'← Continua gli acquisti',checkoutTitle:'Pagamento',checkoutIntro:'Il tuo ordine è pronto. Il pagamento e il collegamento al fornitore devono ancora essere attivati prima di poter elaborare un pagamento reale.',adjustCart:'Modifica carrello'},
